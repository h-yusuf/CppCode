...
using namespace std;
    ...
    char resepsionis[30], customer[30];
    string alamat,jk;
    double id_customer, id_resepsionis, hp;
    int kamar_total, lama, harga_kamar, um, biaya_total;
    float diskon;
    
void header(){
	cout<<"\n\t\t      =========================================================================";
    cout<<"\n\t\t   ==============================================================================";
    cout<<"\n\t\t                   SELAMAT DATANG DI HOTEL AMIKOM YOGYAKARTA                    ";
    cout<<"\n\n\t\t               JL. Kita Masih Panjang, no 69 telp private number              ";
    cout<<"\n\t\t                 Legok Jawa, Lembur Kami, Dimana-mana Hati Ku Senang            ";
	cout<<"\n\t\t=================================================================================";
	cout<<"\n\t\t=================================================================================";
}

void data_resepsionis(){
...
void hitung() {
	kamar_total = lama*harga_kamar;
	diskon = diskon*harga_kamar;
	biaya_total=kamar_total - diskon;
}
main () {
    int kamar, no_kamar, ranjang;
    string jwb, checkin, checkout, fixkam;
    awal:
    header();      
	data_resepsionis();
    ...
    cout<<"\n\t\tHarga Kamar Total: Rp. "<<kamar_total;
    ...
    cout<<"\n\n\t\tTerima Kasih Telah Memilih Hotel AMIKOM YOGYAKARTA";
