...
int harga_makan,harga_minum,harga_desert, total_bayar, jumlah_pesanan, nomor_meja, uang,kembali,ttl_makan,ttl_minum,ttl_desert,jumlah_pesanan2,jumlah_pesanan3;
...
void pesanan(){
	...
	cout<<"Uang        = ";cin>>uang;
	cout<<"Kembali     = "<<uang-total_bayar<<endl;
	if(uang<total_bayar){
